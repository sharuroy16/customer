 ...
 * @EnableJpaRepositories: this tells Spring Data JPA to look for repository classes in the specified package (com.customer.repository) 
 ...
 * 
 * In this class, the first method creates an instance of EntityManagerFactory to manage the persistence unit 'CustomerPersistance' 
...
public class JpaConfig {
    ...
    public LocalEntityManagerFactoryBean entityManagerFactory() {
        ...
        factoryBean.setPersistenceUnitName("CustomerPersistance");
        return factoryBean;
    }
